...
import com.cainiao5.cainiaomusic.data.Playlist;
            ...
            case 1:
                ...
                if (createdExpanded && playlist.author.equals("local")) {
                    if (playlist.albumArt != null)
                        GlideUtils.withUri(mContext,Uri.parse(playlist.albumArt));
...
//    }
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ItemHolder(View view) {
            ...
            this.albumArt = (ImageView) view.findViewById(R.id.fragment_main_playlist_item_img);
