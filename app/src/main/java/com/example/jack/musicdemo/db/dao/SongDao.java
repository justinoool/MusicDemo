package com.example.jack.musicdemo.db.dao;
...
public class SongDao extends BaseDao {
    ...
    private final static String COLUMN_SID = "sid";//正数表示为网络歌曲，负数表示为本地歌曲
    ...
    private final static String COLUMN_URL = "url";//歌曲地址
    private final static String COLUMN_SIZE = "size";
    private final static String COLUMN_DURATION = "duration";//时长
    ...
    private final static String COLUMN_COVER_URL = "cover_url";//封面地址
    ...
    public static String createTable() {
        ...
        sb.append(COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,");//主键自增加
